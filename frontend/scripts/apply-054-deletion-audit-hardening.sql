...
-- Migration equivalente: supabase/migrations/054_deletion_audit_hardening.sql
...
-- Sem policies UPDATE/DELETE (RLS já bloqueia). Trigger reforça imutabilidade mesmo com service role.
...
-- Restaura soft-delete e marca o evento (SECURITY DEFINER; só admin da empresa).

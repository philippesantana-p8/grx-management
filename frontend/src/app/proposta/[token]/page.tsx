...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const pageUrl = `${APP_URL}/proposta/${token}`;
  const ogImage = `${APP_URL}/proposta/${token}/opengraph-image?v=7`;
  ...
  return {
    ...
    openGraph: {
      title: "Proposta GRX — Transportes e Logística",
      description: "Proposta de frete — confirme pelo link",
      url: pageUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Proposta GRX Transportes e Logística",
        },
      ],
    },
    twitter: {

...
| CNH motorista | Alerta por validade (2 meses / 1 mês). **Renovar CNH** ou digitalizar nova CNH **sobrescreve** número/validade; ao salvar com validade em dia o alerta antigo some. Anexos em subpastas **CNH** e **CNH-AVC** no cadastro do motorista. |

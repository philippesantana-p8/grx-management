...
| Marca / logos | **Sistema (menu + login):** PSCS Systems 3D (`/pscs-logo-mark.png`, `BrandLogo` variant `mark`) — “Systems” começa no meio do PSCS e segue à direita. **Header (cliente):** emblema da empresa sem fundo (`/grx-company-mark.png`) no oval amarelo. **Docs (voucher/proposta/e-mail):** logo GRX em placa. |

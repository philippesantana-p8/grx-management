...
| Marca / logos | **Sistema (menu + login):** PSCS Systems 3D (`/pscs-logo-mark.png`, `BrandLogo` variant `mark`). **Empresa (voucher/proposta/e-mail):** logo do adquirente (hoje GRX). Header com logo da empresa ainda pendente de ok. |

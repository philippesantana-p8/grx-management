...
| Marca / logos | **Sistema (menu + login):** Logistics AI Platform (`/pscs-logo-mark.png`) — branco + amarelo fiéis à arte, fundo transparente (sem preto da arte). Login: faixa escura só para contraste. **Header (cliente):** **GRX Transportes e Logística** liquid glass. |

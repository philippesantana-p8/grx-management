...
| Estacionamento / Lava | Módulos próprios: portes + tabela de preços (diária/mensal/lava) em **Parâmetros do pátio**; ordens em Operacional → Estacionamento / Lava-rápido; DRE **Receita Estacionamento** / **Receita Lava Rápido** no fechamento. SQL: `apply-041-patio-parking-wash.sql`. Na OS geral, **Tipo de operação** só **Frete** e **Transporte**. |

...
| Marca / logos | **Sistema (menu + login):** PSCS Systems 3D — “Systems” no meio→direita com contorno branco. **Header (cliente):** texto do nome da empresa (ex.: **GRX Transport Logistics**) — sem logo de imagem. **Docs:** logo GRX em placa. |

...
| Marca / logos | **Sistema (menu + login):** Logistics AI Platform P&B (`/pscs-logo-mark.png`) — branco no menu escuro; preto no login (invert); sem fio preto interno (Philippe). **Header (cliente):** texto **GRX Transportes e Logística** liquid glass. **Docs:** logo GRX em placa. |

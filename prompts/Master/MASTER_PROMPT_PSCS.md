...
| Shell / Rateio | AppShell em altura de viewport: **menu lateral fixo** (rola só o nav interno); conteúdo rola no `main`. **Rateio por OS → Detalhe OS × sócio**: scroll próprio com **cabeçalho + coluna OS fixos** (padrão Agenda). |
